      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="#">Nupe</a>
              <a class="dropdown-item" href="#">Portaria</a>
              <a class="dropdown-item" href="view/pagina_discente.php">Aluno</a>
            </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="index.php">Sobre <span class="sr-only">(current)</span></a>
        </li>
      </ul>
