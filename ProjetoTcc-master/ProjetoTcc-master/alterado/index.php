  ...
  <center style = "margin-top: 20%;">
           <h1 class="animated fadeInLeftBig tituloIndex">Controle de acesso IFC</h1>
             <a href="view/usuario_cadastro.php"><button type="button" class="btn btn-outline-light my-2 my-sm-">Cadastre-se</button></a>
               <a href="view/login.php"><button type="button" class="btn btn-outline-light my-2 my-sm-">Entrar</button></a>
  ...
  <section class="cards_home">
    ...
    <img src="./img/seg.png" class="card-img-top" alt="...">
    <div class="card-body">
